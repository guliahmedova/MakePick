...
const ProductCard = ({ title, discPrice, price, imgs, discount, desc, tags }) => {
    return (
        <>
            ...
            <ProductPopup imgs={imgs} title={title} desc={desc} tags={tags} price = {price} discPrice = {discPrice} discount={discount} />
        </>
    )
}
