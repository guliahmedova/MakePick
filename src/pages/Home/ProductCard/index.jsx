...
const ProductCard = ({ title, discPrice, price, imgs, discount, desc, tags, id }) => {
    ...
    const handleAddToCart = () => {
        ref.current.classList.add(style.send_to_cart);
        setTimeout(() => {
            ref.current.classList.remove(style.send_to_cart);
        }, 2000);
    };
        ...
        <>
            <div className="bg-white rounded-lg shadow p-3 cursor-pointer"
                ...
                <div className="relative">
                    ...
                    <div className={`w-20 h-20 border rounded-full absolute z-[80] ${style.cart_item}`} ref={ref}>
                        <img src={imgs[0]} alt="" className="w-full h-full rounded-full shadow" />
                    </div>
                    <img src={imgs[0]} className="lg:w-52 mx-auto w-44" alt="" />
                </div>
                <div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button type="button" onClick={(e) => {
                            ...
                            e.stopPropagation();
                            handleAddToCart();
                        }} className="flex items-center group hover:bg-[#009e7f] text-[#009e7f] hover:text-white duration-300 ease-in-out gap-3 border-2 shadow-sm rounded-3xl px-3 py-2 font-medium hover:fill-slate-50">
