            ...
            <div className={`flex flex-col items-center justify-center lg:h-full h-fit transition-all duration-500 ease-in-out ${isModalOpen ? 'scale-100' : 'scale-0'}`}>
                <div className="bg-white lg:w-4/12 md:w-7/12 w-11/12 h-fit rounded shadow">
                    <form action="#" className="p-6">
                        ...
                        <input type="text" placeholder="joe@gmail.com" className="bg-gray-100 mt-3 block w-full py-4 px-2 border shadow-sm rounded-md outline-[#009e7f]" />
                        <input type="password" className="bg-gray-100 mt-3 block w-full py-4 px-2 border shadow-sm rounded-md outline-[#009e7f]" />
                        <button className="bg-[#009e7f] shadow-md rounded-md text-white font-medium w-full mt-3 py-4 text-xl">Continue</button>
